...
│         .V0@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@0?.        │ ──────────────── │   │
│       _l#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@#l`      │ OS: Human v22.0  │   │
│     `o@@@@@@@@v^r}P0@@@@@@@@@@@@@@@@@@@@ghlr<r@@@@@@@#o`    │ Host: Earth 🌍   │   │
│    ;0@@@@@@@@0      .?szL?*;!!!!~*|]Vox_      p@@@@@@@@0;   │ Kernel: Coder 💻 │   │
│   ?@@@@@@@@@@q                                z@@@@@@@@@@?  │ Uptime: 22 yrs   │   │
│  :@@@@@@@@@@@Q                                R@@@@@@@@@@@: │ Shell: zsh 🐚    │   │
│ _g@@@@@@@@@@2-                                -2@@@@@@@@@@_ │ DE: VS Code 📝   │   │
│ a@@@@@@@@@@2                                    v@@@@@@@@@@a│ WM: i3 🪟        │   │
...
│                  `.:^|v}LVzsszzLV}|^:.`                                             │
│                                                                                     │
│  suman@dev-machine:~$ cat /etc/os-release                                           │
│  > NAME="Suman Mehta"                                                               │
...
<h3 align="center">🛠️ TOOLS & IDEs 🛠️</h3>
...
```diff
+ ╔══════════════════════════════════════════════════════════════════════════════╗
+ ║  SYSTEM STATUS: FULLY OPERATIONAL    ||    MODE: PRODUCTION READY            ║
+ ║  UPTIME: 99.99%                      ||    VIBES: MAXIMUM                    ║
+ ║  COFFEE: REFILL REQUIRED             ||    BUGS: ELIMINATED                   ║
+ ╚══════════════════════════════════════════════════════════════════════════════╝
```

### 🔥 **Crafted with** `coffee.addiction = true` **&** `sleep.deprivation = false` **by Suman Mehta** 🔥

<br>

[![Visitors](https://visitor-badge.laobi.icu/badge?page_id=suman-mehta.suman-mehta&left_color=0d1117&right_color=00d4ff&left_text=Profile%20Views)](https://github.com/suman-mehta)
[![GitHub followers](https://img.shields.io/github/followers/suman-mehta?style=social)](https://github.com/suman-mehta)
[![GitHub stars](https://img.shields.io/github/stars/suman-mehta?style=social)](https://github.com/suman-mehta)
